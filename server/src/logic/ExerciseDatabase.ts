...
export const EXERCISE_DATABASE: Exercise[] = [
    ...
    // LEGS - PIERNAS
    { id: 'lg1', name: 'Sentadilla Trasera con Barra', muscle_group: 'quads', type: 'compound', equipment: ['full-gym', 'home-gym'], difficulty: 'intermediate', image_url: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=600&auto=format&fit=crop' }, // Correct Squat/Barbell visual
    { id: 'lg2', name: 'Prensa Inclinada 45°', muscle_group: 'quads', type: 'compound', equipment: ['full-gym'], difficulty: 'beginner', image_url: 'https://images.unsplash.com/photo-1540497077202-7c8a3999166f?q=80&w=600&auto=format&fit=crop' }, // Leg machine
    { id: 'lg3', name: 'Estocadas con Mancuernas', muscle_group: 'legs', type: 'compound', equipment: ['full-gym', 'dumbbells-only', 'home-gym'], difficulty: 'beginner', image_url: 'https://images.unsplash.com/photo-1574680676118-028a364ef731?q=80&w=600&auto=format&fit=crop' },
    { id: 'lg4', name: 'Extensión de Cuádriceps', muscle_group: 'quads', type: 'isolation', equipment: ['full-gym'], difficulty: 'beginner', image_url: 'https://images.unsplash.com/photo-1540497077202-7c8a3999166f?q=80&w=600&auto=format&fit=crop' },
    { id: 'lg5', name: 'Peso Muerto Rumano', muscle_group: 'hamstrings', type: 'compound', equipment: ['full-gym', 'home-gym', 'dumbbells-only'], difficulty: 'intermediate', image_url: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=600&auto=format&fit=crop' }, // RDL Barbell
    { id: 'lg6', name: 'Curl Femoral Tumbado', muscle_group: 'hamstrings', type: 'isolation', equipment: ['full-gym'], difficulty: 'beginner', image_url: 'https://images.unsplash.com/photo-1540497077202-7c8a3999166f?q=80&w=600&auto=format&fit=crop' },
    { id: 'lg7', name: 'Hip Thrust (Empuje de Cadera)', muscle_group: 'glutes', type: 'compound', equipment: ['full-gym', 'home-gym'], difficulty: 'beginner', image_url: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=600&auto=format&fit=crop' }, // Hip thrust barbell visualization
    { id: 'lg8', name: 'Elevación de Talones (Calf Raise)', muscle_group: 'calves', type: 'isolation', equipment: ['full-gym', 'home-gym', 'dumbbells-only'], difficulty: 'beginner', image_url: 'https://images.unsplash.com/photo-1599388137356-ccf351336a5b?q=80&w=600&auto=format&fit=crop' },
